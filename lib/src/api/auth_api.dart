...
class AuthApi {
  ...
  Future<Response<AccessTokenRequest>> authorizeAccessTokenRequest({ 
    ...
    final _path = r'/auth/access-token-requests/{requestID}/authorize/'.replaceAll('{' r'requestID' '}', requestID.toString());
    ...
    return Response<AccessTokenRequest>(
      data: _responseData,
  ...
  Future<Response<AccessTokenRequest>> createAccessTokenRequest({ 
    ...
    final _path = r'/auth/access-token-requests/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AccessTokenRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AccessTokenRequest>> getAccessTokenRequest({ 
    required String requestID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/auth/access-token-requests/{requestID}/'.replaceAll('{' r'requestID' '}', requestID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TokenLogin>> loginToken({ 
    ...
    final _path = r'/auth/token/login/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LegacyAuthMigrationToken] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<LegacyAuthMigrationToken>> migrateLegacyAuth({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    return Response<LegacyAuthMigrationToken>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TokenObtain] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<TokenObtain>> obtainToken({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/auth/token/obtain/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AccessTokenRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AccessTokenRequest>> revokeAccessTokenRequest({ 
    required String requestID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/auth/access-token-requests/{requestID}/revoke/'.replaceAll('{' r'requestID' '}', requestID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserPhoto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserPhoto>> updateUserPhoto({ 
    UserPhoto? userPhoto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(UserPhoto);
      _bodyData = userPhoto == null ? null : _serializers.serialize(userPhoto, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> updateUserProfile({ 
    User? user,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UserPhoto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserPhoto>> userPhoto({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> userProfile({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
