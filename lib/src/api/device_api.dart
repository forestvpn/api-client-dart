...
class DeviceApi {
  ...
  Future<Response<Device>> createDevice({ 
    ...
    try {
      const _type = FullType(CreateOrUpdateDeviceRequest);
      _bodyData = createOrUpdateDeviceRequest == null ? null : _serializers.serialize(createOrUpdateDeviceRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdvertisedRoute] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AdvertisedRoute>> createDeviceAvdertisedRoute({ 
    required String deviceID,
    AdvertisedRoute? advertisedRoute,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/devices/{deviceID}/advertised-routes/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AdvertisedRoute);
      _bodyData = advertisedRoute == null ? null : _serializers.serialize(advertisedRoute, specifiedType: _type);
    ...
    return Response<AdvertisedRoute>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PortForwarding] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PortForwarding>> createDevicePortForwarding({ 
    required String deviceID,
    ...
    final _path = r'/devices/{deviceID}/port-forwarding/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateOrUpdatePortForwardingRequest);
      _bodyData = createOrUpdatePortForwardingRequest == null ? null : _serializers.serialize(createOrUpdatePortForwardingRequest, specifiedType: _type);
    ...
    return Response<PortForwarding>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> deleteDevice({ 
    ...
    final _path = r'/devices/{deviceID}/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteDevicePortForwarding({ 
    required String deviceID,
    required String portForwardingID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/devices/{deviceID}/port-forwarding/{portForwardingID}/'.replaceAll('{' r'deviceID' '}', deviceID.toString()).replaceAll('{' r'portForwardingID' '}', portForwardingID.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DeviceStats>> getDeviceStats({ 
    required String deviceID,
    ...
    final _path = r'/devices/{deviceID}/stats/{statsID}/'.replaceAll('{' r'deviceID' '}', deviceID.toString()).replaceAll('{' r'statsID' '}', statsID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [WireGuard] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<WireGuard>> getDeviceWireGuard({ 
    required String deviceID,
    required String wireGuardID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/devices/{deviceID}/wireguards/{wireGuardID}/'.replaceAll('{' r'deviceID' '}', deviceID.toString()).replaceAll('{' r'wireGuardID' '}', wireGuardID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<String>> getWireGuardConf({ 
    required String deviceID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/devices/{deviceID}/wireguard.conf'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<AdvertisedRoute>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<AdvertisedRoute>>> listDeviceAdvertisedRoutes({ 
    required String deviceID,
    int? perPage,
    int? page,
    CancelToken? cancelToken,
    ...
    return Response<BuiltList<AdvertisedRoute>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<String>>> listDeviceBindings({ 
    required String deviceID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/devices/{deviceID}/bindings/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ConnectionMode>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ConnectionMode>>> listDeviceConnectionModes({ 
    required String deviceID,
    ...
    final _path = r'/devices/{deviceID}/connection-modes/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xAndroidPackage != null) r'X-Android-Package': xAndroidPackage,
        if (xAndroidSHA1 != null) r'X-Android-SHA1': xAndroidSHA1,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
    ...
    return Response<BuiltList<ConnectionMode>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<DeviceStats>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<DeviceStats>>> listDeviceDetailStats({ 
    required String deviceID,
    ...
    final _path = r'/devices/{deviceID}/detail-stats/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<BuiltList<DeviceStats>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<PortForwarding>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<PortForwarding>>> listDevicePortForwardings({ 
    ...
    return Response<BuiltList<PortForwarding>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<DeviceStats>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<DeviceStats>>> listDeviceStats({ 
    required String deviceID,
    Date? dateAfter,
    Date? dateBefore,
    int? perPage,
    ...
    final _path = r'/devices/{deviceID}/stats/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<WireGuardPeer>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<WireGuardPeer>>> listDeviceWireGuardPeers({ 
    required String deviceID,
    required String wireGuardID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/devices/{deviceID}/wireguards/{wireGuardID}/peers/'.replaceAll('{' r'deviceID' '}', deviceID.toString()).replaceAll('{' r'wireGuardID' '}', wireGuardID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<BuiltList<WireGuardPeer>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<WireGuard>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<WireGuard>>> listDeviceWireGuards({ 
    ...
    final _path = r'/devices/{deviceID}/wireguards/'.replaceAll('{' r'deviceID' '}', deviceID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<BuiltList<WireGuard>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Device>> updateDevice({ 
    required String deviceID,
    required CreateOrUpdateDeviceRequest createOrUpdateDeviceRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateOrUpdateDeviceRequest);
      _bodyData = _serializers.serialize(createOrUpdateDeviceRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [PortForwarding] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PortForwarding>> updateDevicePortForwarding({ 
    required String deviceID,
    required String portForwardingID,
    required CreateOrUpdatePortForwardingRequest createOrUpdatePortForwardingRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateOrUpdatePortForwardingRequest);
      _bodyData = _serializers.serialize(createOrUpdatePortForwardingRequest, specifiedType: _type);
