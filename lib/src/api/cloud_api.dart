...
class CloudApi {
  ...
  Future<Response<void>> deleteTask({ 
    ...
    final _path = r'/cloud/tasks/{taskID}/'.replaceAll('{' r'taskID' '}', taskID.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [assignmentDateAfter] - No more than 3 months between assignment_date_after and assignment_date_before
  /// * [assignmentDateBefore] - No more than 3 months between assignment_date_after and assignment_date_before
  /// * [functionIn] - Filter by function
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<AggregatedFunctionStats>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<AggregatedFunctionStats>>> getFunctionStats({ 
    required String aggrInterval,
    Date? assignmentDateAfter,
    Date? assignmentDateBefore,
    BuiltList<String>? functionIn,
    String? sortBy,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/cloud/functions/stats/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (assignmentDateAfter != null) r'assignment_date_after': encodeQueryParameter(_serializers, assignmentDateAfter, const FullType(Date)),
      if (assignmentDateBefore != null) r'assignment_date_before': encodeQueryParameter(_serializers, assignmentDateBefore, const FullType(Date)),
      if (functionIn != null) r'function__in': encodeCollectionQueryParameter<String>(_serializers, functionIn, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
    ...
    BuiltList<AggregatedFunctionStats>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(AggregatedFunctionStats)]),
      ) as BuiltList<AggregatedFunctionStats>;
    ...
    return Response<BuiltList<AggregatedFunctionStats>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Task>>> tasksFunctions({ 
    int? perPage,
    int? page,
    BuiltList<String>? functionIn,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [Task] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Task>> updateTask({ 
    required String taskID,
    required Task task,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    try {
      const _type = FullType(Task);
      _bodyData = _serializers.serialize(task, specifiedType: _type);
