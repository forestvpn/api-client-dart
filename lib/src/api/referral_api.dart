...
class ReferralApi {
  ...
  const ReferralApi(this._dio, this._serializers);
  ...
  Future<Response<void>> applyReferralCode({ 
    ...
    final _path = r'/referral/referrals/apply/';
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        r'referral_code': encodeFormParameter(_serializers, referralCode, const FullType(String)),
      });
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ReferralTransaction] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ReferralTransaction>> claimReferralTransaction({ 
    ...
    final _path = r'/referral/transactions/{transactionID}/claim/'.replaceAll('{' r'transactionID' '}', transactionID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<ReferralTransaction>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [ReferralTransaction] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ReferralTransaction>> getReferralTransaction({ 
    required String transactionID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/referral/transactions/{transactionID}/'.replaceAll('{' r'transactionID' '}', transactionID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [q] - Search query
  /// * [sort] - Sort by provided field
  /// * [invitedAtAfter] - Filter by invited date-time after provided value
  /// * [invitedAtBefore] - Filter by invited date-time before provided value
  /// * [isPremium] - Filter by invitees is_premium status
  /// * [perPage] 
  /// * [page] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Referral>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Referral>>> listReferrals({ 
    String? q,
    String? sort,
    DateTime? invitedAtAfter,
    DateTime? invitedAtBefore,
    bool? isPremium,
    int? perPage,
    int? page,
    CancelToken? cancelToken,
    ...
    final _path = r'/referral/referrals/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (invitedAtAfter != null) r'invited_at_after': encodeQueryParameter(_serializers, invitedAtAfter, const FullType(DateTime)),
      if (invitedAtBefore != null) r'invited_at_before': encodeQueryParameter(_serializers, invitedAtBefore, const FullType(DateTime)),
      if (isPremium != null) r'is_premium': encodeQueryParameter(_serializers, isPremium, const FullType(bool)),
      if (perPage != null) r'per_page': encodeQueryParameter(_serializers, perPage, const FullType(int)),
      if (page != null) r'page': encodeQueryParameter(_serializers, page, const FullType(int)),
    };
    ...
    return Response<BuiltList<Referral>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ReferralProfile] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ReferralProfile>> referralProfileDetail({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/referral/profile/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<ReferralProfile>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
