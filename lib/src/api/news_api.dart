...
class NewsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [NotificationDetail] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<NotificationDetail>> getNotification({ 
    ...
    final _path = r'/news/notifications/{notificationID}/'.replaceAll('{' r'notificationID' '}', notificationID.toString());
    ...
    NotificationDetail _responseData;

    try {
      const _responseType = FullType(NotificationDetail);
    ...
    return Response<NotificationDetail>(
      data: _responseData,
  ...
  Future<Response<BuiltList<Notification>>> listNotifications({ 
    ...
    final _path = r'/news/notifications/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (isPublished != null) r'is_published': encodeQueryParameter(_serializers, isPublished, const FullType(bool)),
    };
  ...
  Future<Response<void>> updateNotificationMarkRead({ 
    ...
    final _path = r'/news/notifications/{notificationID}/mark_read/'.replaceAll('{' r'notificationID' '}', notificationID.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> updateNotificationMarkReadAll({ 
    ...
    final _path = r'/news/notifications/mark_read_all/';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
