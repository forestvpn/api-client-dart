...
class AdsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateAdUnitRequestLogRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CreateAdUnitRequestLogRequest>> createAdUnitRequestLog({ 
    ...
    final _path = r'/ads/request-logs/';
    ...
    try {
      const _type = FullType(CreateAdUnitRequestLogRequest);
      _bodyData = createAdUnitRequestLogRequest == null ? null : _serializers.serialize(createAdUnitRequestLogRequest, specifiedType: _type);
    ...
    return Response<CreateAdUnitRequestLogRequest>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<AdPlacement>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<AdPlacement>>> listAdPlacements({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    return Response<BuiltList<AdPlacement>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
