...
class FriendshipApi {
  ...
  Future<Response<void>> deleteFriend({ 
    required String id,
    ...
    final _path = r'/friendship/friends/{id}/'.replaceAll('{' r'id' '}', id.toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [Friendship] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Friendship>> getFriend({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<BuiltList<Friendship>>> listFriends({ 
    ...
    final _path = r'/friendship/friends/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
