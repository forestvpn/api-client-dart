...
class LimitsApi {
  ...
  const LimitsApi(this._dio, this._serializers);
  ...
  Future<Response<DataUsageLimit>> createDataUsageLimit({ 
    ...
    final _path = r'/limits/data-usage/';
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deleteDataUsageLimit({ 
    ...
    final _path = r'/limits/data-usage/{limitId}/'.replaceAll('{' r'limitId' '}', limitId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DataUsageLimit] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataUsageLimit>> getDataUsageLimit({ 
    required String limitId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<DataUsageLimit>>> lisDataUsageLimits({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [DataUsageLimit] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataUsageLimit>> partialUpdateDataUsageLimit({ 
    required String limitId,
  ...
  /// Returns a [Future] containing a [Response] with a [DataUsageLimit] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<DataUsageLimit>> updateDataUsageLimit({ 
    required String limitId,
    required CreateOrUpdateDataUsageLimitRequest createOrUpdateDataUsageLimitRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
