...
class CheckoutApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CouponCheckoutSession] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CouponCheckoutSession>> applyCouponCheckoutSession({ 
    required String sessionID,
    required CreateCouponCheckoutSession createCouponCheckoutSession,
    ...
    final _path = r'/checkout/sessions/{sessionID}/apply_coupon/'.replaceAll('{' r'sessionID' '}', sessionID.toString());
    ...
    try {
      const _type = FullType(CreateCouponCheckoutSession);
      _bodyData = _serializers.serialize(createCouponCheckoutSession, specifiedType: _type);
    ...
    return Response<CouponCheckoutSession>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CheckoutSession>> createCheckoutSession({ 
    ...
    final _path = r'/checkout/sessions/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> createWaitListRequest({ 
    String? xCountry,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/checkout/wait-list/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xCountry != null) r'X-Country': xCountry,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> expireCheckoutSession({ 
    required String sessionID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/checkout/sessions/{sessionID}/expire/'.replaceAll('{' r'sessionID' '}', sessionID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [CheckoutSession] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CheckoutSession>> getCheckoutSession({ 
    required String sessionID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/checkout/sessions/{sessionID}/'.replaceAll('{' r'sessionID' '}', sessionID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StripeCheckoutSession] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StripeCheckoutSession>> getStripeCheckoutSession({ 
    required String sessionID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/checkout/sessions/{sessionID}/stripe/checkout/session/'.replaceAll('{' r'sessionID' '}', sessionID.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CloudPaymentsAuth] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CloudPaymentsAuth>> processCloudPaymentsAuth({ 
    required String sessionID,
    required CreateCloudPaymentsAuth createCloudPaymentsAuth,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/checkout/sessions/{sessionID}/cloud-payments/auth/'.replaceAll('{' r'sessionID' '}', sessionID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateCloudPaymentsAuth);
      _bodyData = _serializers.serialize(createCloudPaymentsAuth, specifiedType: _type);
    ...
    return Response<CloudPaymentsAuth>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CloudPaymentsPost3ds] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<CloudPaymentsPost3ds>> processCloudPaymentsPost3ds({ 
    required String sessionID,
    required CreateCloudPaymentsPost3ds createCloudPaymentsPost3ds,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/checkout/sessions/{sessionID}/cloud-payments/post3ds/'.replaceAll('{' r'sessionID' '}', sessionID.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateCloudPaymentsPost3ds);
      _bodyData = _serializers.serialize(createCloudPaymentsPost3ds, specifiedType: _type);
    ...
    return Response<CloudPaymentsPost3ds>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
