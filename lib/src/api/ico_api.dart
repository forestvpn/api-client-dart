...
class IcoApi {
  ...
  const IcoApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ICOLanding] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ICOLanding>> iCOLanding({ 
