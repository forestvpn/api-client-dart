...
class _$AdProvider extends AdProvider {
  ...
  factory _$AdProvider([void Function(AdProviderBuilder)? updates]) =>
      (new AdProviderBuilder()..update(updates)).build();

  _$AdProvider._({required this.id, required this.slug, required this.name})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, 'AdProvider', 'id');
    BuiltValueNullFieldError.checkNotNull(slug, 'AdProvider', 'slug');
    BuiltValueNullFieldError.checkNotNull(name, 'AdProvider', 'name');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AdProvider')
          ..add('id', id)
          ..add('slug', slug)
          ..add('name', name))
        .toString();
...
class AdProviderBuilder implements Builder<AdProvider, AdProviderBuilder> {
  ...
  _$AdProvider build() {
    final _$result = _$v ??
        new _$AdProvider._(
            id: BuiltValueNullFieldError.checkNotNull(id, 'AdProvider', 'id'),
            slug: BuiltValueNullFieldError.checkNotNull(
                slug, 'AdProvider', 'slug'),
