...
class _$NetworkService extends NetworkService {
  ...
  factory _$NetworkService([void Function(NetworkServiceBuilder)? updates]) =>
      (new NetworkServiceBuilder()..update(updates)).build();

  _$NetworkService._({required this.proto, required this.connectionUri})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(proto, 'NetworkService', 'proto');
    BuiltValueNullFieldError.checkNotNull(
        connectionUri, 'NetworkService', 'connectionUri');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('NetworkService')
          ..add('proto', proto)
