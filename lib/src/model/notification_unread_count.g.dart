...
class _$NotificationUnreadCount extends NotificationUnreadCount {
  ...
  factory _$NotificationUnreadCount(
      ...
      (new NotificationUnreadCountBuilder()..update(updates)).build();

  _$NotificationUnreadCount._({required this.count}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        count, 'NotificationUnreadCount', 'count');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('NotificationUnreadCount')
          ..add('count', count))
        .toString();
  }
}
...
class NotificationUnreadCountBuilder
  ...
  @override
  _$NotificationUnreadCount build() {
    final _$result = _$v ??
