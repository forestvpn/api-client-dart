...
class _$FCMDevice extends FCMDevice {
  ...
  factory _$FCMDevice([void Function(FCMDeviceBuilder)? updates]) =>
      (new FCMDeviceBuilder()..update(updates)).build();
  ...
  _$FCMDevice._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        registrationId, 'FCMDevice', 'registrationId');
    BuiltValueNullFieldError.checkNotNull(active, 'FCMDevice', 'active');
    BuiltValueNullFieldError.checkNotNull(createdAt, 'FCMDevice', 'createdAt');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('FCMDevice')
