...
class _$CreateCloudPaymentsAuth extends CreateCloudPaymentsAuth {
  ...
  factory _$CreateCloudPaymentsAuth(
      ...
      (new CreateCloudPaymentsAuthBuilder()..update(updates)).build();

  _$CreateCloudPaymentsAuth._({required this.cryptogram, required this.name})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        cryptogram, 'CreateCloudPaymentsAuth', 'cryptogram');
    BuiltValueNullFieldError.checkNotNull(
        name, 'CreateCloudPaymentsAuth', 'name');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CreateCloudPaymentsAuth')
...
class CreateCloudPaymentsAuthBuilder
  ...
  @override
  _$CreateCloudPaymentsAuth build() {
    final _$result = _$v ??
