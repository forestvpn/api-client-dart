...
class _$AppStoreReceiptVerificationRequest
  ...
  _$AppStoreReceiptVerificationRequest._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        receipt, 'AppStoreReceiptVerificationRequest', 'receipt');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('AppStoreReceiptVerificationRequest')
          ..add('receipt', receipt)
          ..add('price', price)
...
class AppStoreReceiptVerificationRequestBuilder
  ...
  @override
  _$AppStoreReceiptVerificationRequest build() {
    final _$result = _$v ??
