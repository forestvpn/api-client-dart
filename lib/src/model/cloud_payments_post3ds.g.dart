...
class _$CloudPaymentsPost3ds extends CloudPaymentsPost3ds {
  ...
  factory _$CloudPaymentsPost3ds(
      ...
      (new CloudPaymentsPost3dsBuilder()..update(updates)).build();

  _$CloudPaymentsPost3ds._({required this.transactionId}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        transactionId, 'CloudPaymentsPost3ds', 'transactionId');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CloudPaymentsPost3ds')
